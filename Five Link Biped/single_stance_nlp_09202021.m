...
t1=0; tf=3; t_list=linspace(t1,tf,n); h=(tf-t1)/(n-1); % Step size
qi_list=[-10,-25,10,10,25]/180*pi; qf_list=[25,10,10,-25,-10]/180*pi;
...
A=zeros(n,60*n); b=zeros(n,1);
A(:,(15*n+10):10:(25*n))=-1*eye(n);
...
options = optimoptions('fmincon','MaxFunctionEvaluations',20000,'TolFun',1e-6);
