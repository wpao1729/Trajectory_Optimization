...
P_mat=zeros(10,n); G_mat=zeros(10,n); vG_mat=zeros(10,n); aG_mat=zeros(10,n); u_mat=zeros(5,n);
for i=1:n % at every knot point
    ...
    for k=1:5
        ...
        u_mat(k,i)=-sum(torqueG_list(k:5))+sum(accel_list(k:5));
    end
end
...
var_list_guess((55*n+1):(60*n))=reshape(u_mat,1,5*n);
