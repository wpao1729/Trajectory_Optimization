function var_list_guess=initialize_standing_jump_contact_implicit(n,qi_list,qf_list,L_list,d_list,m_list,I_list,g,d_jump,h_jump,tf)

var_list_guess=zeros(1,42*n);
